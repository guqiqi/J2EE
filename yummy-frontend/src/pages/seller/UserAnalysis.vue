...
<script>
  export default {
    ...
    data() {
      return {
        hourData: [[0, 0, 0, 2, 2, 0, 1, 0, 3, 2, 0, 1], [0, 0, 0, 10.3, 15.9, 0, 25.6, 0, 24.8, 9.4, 0, 20.4], [0, 0, 0, 8.3, 12.9, 0, 23.6, 0, 21.8, 8.4, 0, 19.4], [0, 0, 0, 8.0, 12.4, 0, 23.2, 0, 21.1, 7.9, 0, 18.4]],
        weekData: [[2, 1, 0, 1, 3, 0, 4], [22.9, 16.3, 0, 22.3, 13.8, 0, 17.8], [20.9, 14.3, 0, 20.3, 10.8, 0, 16.8], [19.9, 13.3, 0, 19.5, 8.8, 0, 14.8]],
        monthData: [[0, 2, 3, 1, 4, 1], [0, 15.9, 10.3, 14, 23.3, 30.8, 0, 0, 0, 0, 0, 0], [0, 10.9, 8.3, 11.5, 20.3, 27.8, 0, 0, 0, 0, 0, 0], [0, 10.4, 7.3, 10.5, 19.7, 25.8, 0, 0, 0, 0, 0, 0]],
        quarterData: [[5, 6, 0, 0], [19.3, 24, 0, 0], [17.5, 20, 0, 0], [16.8, 18, 0, 0]],
